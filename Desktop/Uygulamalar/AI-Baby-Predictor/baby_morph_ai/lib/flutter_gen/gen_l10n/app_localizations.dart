...
/// ## Update pubspec.yaml
///
/// Make sure to update your pubspec.yaml file to include the following
/// packages:
///
/// ```yaml
/// dependencies:
...
abstract class AppLocalizations {
  ...
  /// No description provided for @motherPhoto.
  ///
  /// In tr, this message translates to:
  /// **'Anne Fotoğrafı'**
  String get motherPhoto;

  /// No description provided for @fatherPhoto.
  ///
  /// In tr, this message translates to:
  /// **'Baba Fotoğrafı'**
  String get fatherPhoto;

  /// No description provided for @seeTheBaby.
  ///
  /// In tr, this message translates to:
  /// **'Bebeği Gör'**
  ...
  /// No description provided for @forEntertainment.
  ///
  /// In tr, this message translates to:
